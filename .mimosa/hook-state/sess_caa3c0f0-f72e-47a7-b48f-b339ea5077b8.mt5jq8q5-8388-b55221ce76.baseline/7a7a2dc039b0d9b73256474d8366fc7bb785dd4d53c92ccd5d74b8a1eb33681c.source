...
<!-- Mandatory block. Filled by /setup Phase 4 step 3a. Two cases: -->

<!-- CASE A — wiki loaded: distill from the LLM Wiki cross-language cookbook
     <wiki-root>/queries/coding-standards-cross-language-cookbook.md
     Keep the six split signals + escalation covenant wording intact. -->

<!-- CASE B — wiki skipped: distill from agent-skills-standard catalog packs + Core Coding Contract above. Sufficient baseline rules. -->

<!-- One-line status, always present: -->
- **Source:** <!-- wiki loaded: "LLM Wiki cross-language cookbook (<wiki-root>)" | wiki skipped: "agent-skills-standard fallback; re-run /setup with a wiki link to upgrade" -->

<!-- Rules below. When wiki loaded, include the structural split signals + escalation covenant distilled from the cookbook. When wiki skipped, include the rule-basic fallback from agent-skills-standard. -->
