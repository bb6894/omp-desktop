...
(function () {
  ...
  const DEFAULT_DATA = {
    ...
    commands: [
      { name: "plan",     hint: "先拟计划，确认后再写代码",             icon: "◇", group: "模式" },
      { name: "steer",    hint: "工具执行中途打断并转向",               icon: "↺", group: "模式" },
      { name: "compact",  hint: "压缩上下文窗口",                       icon: "▤", group: "会话" },
      { name: "new",      hint: "开始全新会话（历史保留在磁盘）",        icon: "↺", group: "会话" },
      { name: "branch",   hint: "从当前节点派生会话分支",               icon: "⑂", group: "会话" },
      { name: "model",    hint: "切换模型",                             icon: "◉", group: "代理" },
      { name: "thinking", hint: "循环切换思考强度",                     icon: "✶", group: "代理" },
    ...
    peer: null,
    microcopy: {
      empty:        "交给我一个项目，我来布置好一切。",
      streamingTip: "按 ⎋ 可随时打断 —— 输入框随时待命。",
      paletteTip:   "输入 / 唤出命令 · ⌘K 打开命令面板",
      planTip:      "描述要构建的内容，或对计划提出反馈…",
      todoEmpty:    "还没有计划。在下方把想法说出来。",
      radarHint:    "代理最近很忙 —— 过去 60 秒",
    },
  };
