...
2. **Validation**:
   - Check if `.zcode/` exists (project initialized)
...
3. **Directory Structure**:
   ...
   - Copy templates from `.zcode/memory/_templates/`
...
- [ ] Validates project is initialized (`.zcode/` exists)
...
| Template    | Path                                      |
| ----------- | ----------------------------------------- |
| spec.md     | `.zcode/memory/_templates/spec.md`     |
| prd.md      | `.zcode/memory/_templates/prd.md`      |
| proposal.md | `.zcode/memory/_templates/proposal.md` |
