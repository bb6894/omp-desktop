...
If the repository has a canonical list of commands, reference it (e.g. `.zcode/memory/project/commands.md`).
...
- New dependency or `.zcode/` structure change would be needed
